			...
			<nav className="bg-white dark:bg-gray-800">
				...
				<div className={`absolute bg-white w-full z-50 md:hidden ${toggleNavbar ? 'block' : 'hidden'}`}>
					<div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 flex flex-col">
						<Link href={"/"}>
							<a
								className={`text-gray-400  active:hover:text-gray-900 hover:font-semibold dark:hover:text-white px-3 py-2 rounded-md text-sm ${router.pathname === '/contact' ? 'text-gray-900 font-semibold' : 'font-medium'}`}
							>
							Home
						</a>
						</Link>
