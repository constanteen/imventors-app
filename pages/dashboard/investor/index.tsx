    ...
    <>
      <div className="flex justify-between items-end">
        ...
        <div>
          ...
          <p className="font-semibold text-lg text-gray-700">Investor Samuel</p>
        </div>
      </div>
      <div className="my-8">
        <hr />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 md:gap-20">
        <div className="dashboard_card">
          ...
          <div className="flex justify-between mt-5">
            <p className="flex flex-col text-gray-700"><span>Invested</span> <span>Invention</span></p>
        ...
        <div className="dashboard_card">
          ...
          <div className="flex justify-between mt-5">
            <p className="flex flex-col text-gray-700"><span>Interested</span> <span>Invention</span></p>
            <p className="text-5xl font-extrabold text-gray-700">20</p>
          </div>
        </div>
        <div className="dashboard_card">
      ...
      <div className="mt-10">
        <div className="flex justify-between font-semibold mb-3 text-gray-700">
